...
use oratos::{
    apply_ignore_rules, audit_pages, generate_html_remediation_prompt, generate_llms_txt,
    generate_metadata_recommendations, generate_phoenix_remediation_prompt, load_pages,
    CrawlOptions, LoadOptions, OratosConfig, ReportFormat, Severity,
};
...
async fn resolve_prompt_page(
    file_or_url: &str,
) -> Result<(String, Vec<oratos::HtmlPage>, oratos::HtmlPage)> {
