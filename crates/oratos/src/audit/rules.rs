...
fn heading_hierarchy_skip(headings: &[crate::html::Heading]) -> bool {
...
fn likely_meaningful_image(img: &crate::html::ImageInfo) -> bool {
...
fn resolve_local_target(page_path: &str, href: &str, ctx: &AuditContext) -> Option<bool> {
    ...
    if let Some(resolved) = crate::html::resolve_internal_path(&page_dir, href) {
