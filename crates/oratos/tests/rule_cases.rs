...
use oratos::html::{load_pages, parse_html, LoadOptions};
...
fn audit_html_in_temp_dir(html: &str, page_name: &str) -> oratos::core::AuditReport {
...
fn has_rule(report: &oratos::core::AuditReport, rule_id: &str) -> bool {
...
async fn url_target_kind_is_url() {
    use oratos::audit::resolve_target;
